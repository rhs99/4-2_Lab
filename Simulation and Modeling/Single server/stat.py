...
inter_arrival_expo_bin = [0,inter_arrival_beta/2,inter_arrival_beta,inter_arrival_beta*2,inter_arrival_beta*3,inter_arrival_beta*40]
inter_arrival_expo_bin_cnt =  np.zeros((len(inter_arrival_expo_bin),), dtype=float)

service_expo_bin = [0,service_beta/2,service_beta,service_beta*2,service_beta*3,service_beta*40]
